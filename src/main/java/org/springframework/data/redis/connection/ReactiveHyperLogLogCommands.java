...
public interface ReactiveHyperLogLogCommands {
	 ...
	 * @author Christoph Strobl
	 */
	public class PfAddCommand extends KeyCommand {

		private final List<ByteBuffer> values;

		public PfAddCommand(ByteBuffer key, List<ByteBuffer> values) {
	...
	public class PfCountCommand implements Command {
		...
		public PfCountCommand(List<ByteBuffer> keys) {
	 ...
	 * @author Christoph Strobl
	 */
	public class PfMergeCommand extends KeyCommand {

		private final List<ByteBuffer> sourceKeys;

		public PfMergeCommand(ByteBuffer key, List<ByteBuffer> sourceKeys) {
